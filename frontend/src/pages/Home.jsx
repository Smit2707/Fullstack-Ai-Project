...
const Home = () => {
  ...
  const handleNewChat = async () => {
    ...
    const response = await axios.post("https://cascadeai.onrender.com/api/chat", {
      title
    }, {
  ...
  useEffect(() => {
    ...
    axios.get("https://cascadeai.onrender.com/api/chat", { withCredentials: true })
      .then(response => {
        dispatch(setChats(response.data.chats.reverse()));
      })

    const tempSocket = io("https://cascadeai.onrender.com", {
      withCredentials: true,
    })
  ...
  const getMessages = async (chatId) => {
   ...
   const response = await  axios.get(`https://cascadeai.onrender.com/api/chat/messages/${chatId}`, { withCredentials: true })
